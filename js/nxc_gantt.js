...
/* \r
   We try to mimic Nextcloud's native classes locally \r
   so it looks right even if strictly isolated style.\r
   In a real NC app, global styles might apply, but scoped ensures we control it.\r
*/
#app-navigation-list[data-v-cced9772] {\r
    list-style: none;\r
    padding: 0;\r
    margin: 0;\r
    display: flex;\r
...
.app-navigation-entry-header[data-v-cced9772] {\r
    padding: 20px 12px 10px;\r
    font-size: 12px;\r
    font-weight: bold;\r
    color: var(--color-text-maxcontrast);\r
    text-transform: uppercase;\r
    opacity: .7;
}
.app-navigation-entry a[data-v-cced9772] {\r
    display: flex;\r
    align-items: center;\r
    width: 100%;\r
    padding: 10px 12px;\r
    box-sizing: border-box;\r
    color: var(--color-main-text);\r
    text-decoration: none;\r
    border-radius: var(--border-radius);\r
    transition: background-color .1s;
}
.app-navigation-entry a[data-v-cced9772]:hover,\r
.app-navigation-entry.active a[data-v-cced9772] {\r
    background-color: var(--color-background-hover);
}
.app-navigation-entry.active a[data-v-cced9772] {\r
    font-weight: bold;
}
.app-navigation-entry-icon[data-v-cced9772] {\r
    width: 14px;\r
    height: 14px;\r
    border-radius: 4px;\r
    margin-right: 12px;\r
...
.app-navigation-entry-icon-svg[data-v-cced9772] {\r
    margin-right: 12px;\r
    opacity: .7;\r
    flex-shrink: 0;
}
.app-navigation-entry-title[data-v-cced9772] {\r
    flex: 1 1;\r
    white-space: nowrap;\r
    overflow: hidden;\r
    text-overflow: ellipsis;
}
.app-navigation-entry-utils[data-v-cced9772] {\r
    display: flex;\r
    align-items: center;
}
.app-navigation-entry-utils-counter[data-v-cced9772] {\r
...
.gantt-container[data-v-24267bd1] {\r
  display: flex;\r
...
.gantt-header-wrapper[data-v-24267bd1] {\r
  overflow: hidden; /* Sync with body scroll in real app */\r
  border-bottom: 1px solid #ddd;\r
  background: white;
}
.gantt-header[data-v-24267bd1] {\r
  height: 60px;\r
  display: flex;\r
  flex-direction: column;
}
.month-row[data-v-24267bd1] {\r
    height: 30px;\r
    display: flex;\r
    border-bottom: 1px solid #eee;\r
    background: #fcfcfc;
}
.month-cell[data-v-24267bd1] {\r
    display: flex;\r
    align-items: center;\r
    padding-left: 8px;\r
    font-weight: bold;\r
...
.days-row[data-v-24267bd1] {\r
  display: flex;\r
  height: 30px;
}
.day-cell[data-v-24267bd1] {\r
  border-right: 1px solid #f0f0f0;\r
  display: flex;\r
  flex-direction: column;\r
  align-items: center;\r
...
.day-num[data-v-24267bd1] {\r
  font-weight: bold;\r
  color: #333;
}
.gantt-body-scroll[data-v-24267bd1] {\r
  flex: 1;\r
  overflow: auto;\r
  position: relative;
}
.gantt-body[data-v-24267bd1] {\r
  position: relative;\r
  background-image: linear-gradient(to right, transparent 49px, #f0f0f0 50px);\r
  background-size: 50px 100%; /* Matches CELL_WIDTH */
}
.connections-layer[data-v-24267bd1] {\r
  position: absolute;\r
  top: 0;\r
  left: 0;\r
  width: 100%;\r
...
.task-row[data-v-24267bd1] {\r
  position: absolute;\r
  left: 0;\r
  width: 100%;\r
  height: 50px; /* ROW_HEIGHT */
}
.task-bar[data-v-24267bd1] {\r
  position: absolute;\r
  height: 36px;\r
  top: 7px; /* (ROW_HEIGHT - 36) / 2 */\r
  border-radius: 6px;\r
  background: #4a90e2; /* Default */\r
  ...
  color: white;\r
  font-size: 0.85rem;\r
  overflow: visible; /* For tooltip */\r
  cursor: grab;\r
  z-index: 20;\r
  transition: transform 0.1s, box-shadow 0.1s;
}
.task-bar[data-v-24267bd1]:active {\r
  cursor: grabbing;
}
.task-bar[data-v-24267bd1]:hover {\r
  transform: scaleY(1.05);\r
  box-shadow: 0 4px 8px rgba(0,0,0,0.15);\r
  z-index: 30;
}
.task-bar.is-dragging[data-v-24267bd1] {\r
  cursor: grabbing;\r
  z-index: 50;\r
  box-shadow: 0 8px 16px rgba(0,0,0,0.2);\r
  transition: none; /* remove transition during drag for responsiveness */
}\r
\r
/* Resize Handles */
.resize-handle[data-v-24267bd1] {\r
  position: absolute;\r
  top: 0;\r
  bottom: 0;\r
  width: 8px;\r
...
.resize-left[data-v-24267bd1] {\r
  left: 0;\r
  border-left: 3px solid rgba(255, 255, 255, 0.8);
}
.resize-right[data-v-24267bd1] {\r
  right: 0;\r
  border-right: 3px solid rgba(255, 255, 255, 0.8);
}
.task-bar:hover .resize-handle[data-v-24267bd1] {\r
  opacity: 1;
}
.task-label[data-v-24267bd1] {\r
  z-index: 2;\r
  white-space: nowrap;\r
  overflow: hidden;\r
  text-overflow: ellipsis;
}
.progress-fill[data-v-24267bd1] {\r
  position: absolute;\r
  left: 0;\r
  top: 0;\r
  height: 100%;\r
...
.tooltip-header[data-v-24267bd1] {\r
  font-weight: bold;\r
  margin-bottom: 4px;
}
.tooltip-dates[data-v-24267bd1] {\r
  font-size: 0.8rem;\r
  color: #666;\r
  margin-bottom: 8px;
}
.tooltip-status[data-v-24267bd1] {\r
  display: flex;\r
  justify-content: space-between;\r
  align-items: center;
}
.status-badge[data-v-24267bd1] {\r
  background: #eee;\r
  padding: 2px 8px;\r
  border-radius: 10px;\r
  font-size: 0.75rem;
...
#app-navigation[data-v-392f462d] {\r
    ...
    height: 100%;\r
    overflow-y: auto;\r
    background-color: #eff6fc; /* Light Blue Sidebar */\r
    border-right: 1px solid var(--color-border, #eee);\r
    flex-shrink: 0;\r
    display: flex;\r
    flex-direction: column;
}
...
\r
:root {\r
  --color-main-background: #ffffff;\r
  --color-main-text: #222222;\r
  --color-primary: #0082c9;\r
  --color-primary-text: #ffffff;\r
  --color-border: #dbdbdb;\r
  --color-background-hover: #f5f5f5;\r
  --border-radius-large: 12px;\r
  --border-radius-pill: 100px;\r
}\r
\r
body {\r
  margin: 0;\r
  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif;\r
  background-color: var(--color-main-background);\r
  color: var(--color-main-text);\r
}\r
\r
#nxc-gantt-root {\r
...
.p-4 { padding: 1rem; }\r
.gap-4 { gap: 1rem; }\r
.font-bold { font-weight: bold; }\r
.text-sm { font-size: 0.875rem; }\r
.text-gray { color: #888; }\r
/*$vite$:1*/`;
...
`], ...formatTraceEntry(entry));
  ...
  **/
            ...
            createBaseVNode("div", {
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.tasks, (task, index) => {
                return openBlock(), createElementBlock("div", {
                  key: task.id,
                  class: "task-row",
                  style: normalizeStyle({ top: `${index * ROW_HEIGHT}px` })
                }, [
                  createBaseVNode("div", {
                    class: normalizeClass(["task-bar", [task.status, { "is-dragging": dragState.value.taskId === task.id }]]),
                    style: normalizeStyle({
                      left: `${getX(task.start)}px`,
                      width: `${getWidth(task.start, task.end)}px`,
                      backgroundColor: task.color
                    }),
                    onMouseenter: ($event) => hoveredTask.value = task,
  ...
  async function fetchBoards() {
    const response = await fetch(`${API_BASE}/boards`, { headers });
    if (!response.ok) throw new Error(`Failed to fetch boards: ${response.statusText}`);
...
${errorBody}`);
  ...
  const _sfc_main = {
    __name: "App",
    setup(__props) {
      const selectedBoardId = /* @__PURE__ */ ref(null);
      const isModalOpen = /* @__PURE__ */ ref(false);
      const editingTask = /* @__PURE__ */ ref({});
      const selectedDepToAdd = /* @__PURE__ */ ref("");
      const loading = /* @__PURE__ */ ref(true);
      const error = /* @__PURE__ */ ref(null);
      const boards = /* @__PURE__ */ ref([]);
      ...
      const availableDependencies = computed(() => {
        ...
        return tasks.value.filter(
          (t) => {
            var _a;
            return t.id !== editingTask.value.id && // not self
            !((_a = editingTask.value.dependencies) == null ? void 0 : _a.includes(t.id));
          }
          // not already added
        );
      });
      ...
      async function loadBoards() {
        try {
          ...
          boards.value = data.map((board) => ({
            ...
            name: board.title,
            count: 0,
            // Not provided by API, could calculate later
            color: board.color || "#0082c9",
            favorite: false
            // Not provided by basic endpoint
          }));
                ...
                createBaseVNode("div", _hoisted_19, [
                  createBaseVNode("div", _hoisted_20, [
                    ...
                    withDirectives(createBaseVNode("select", {
                      ...
                      createBaseVNode("option", { value: "Done" }, "Done", -1)
                    ])], 512), [
                ...
                createBaseVNode("div", _hoisted_22, [
                  ...
                  createBaseVNode("div", _hoisted_23, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(editingTask.value.dependencies, (depId) => {
                      return openBlock(), createElementBlock("div", {
                        ...
                        createTextVNode(toDisplayString(getTaskName(depId)) + " ", 1),
                        createBaseVNode("span", {
                          class: "remove-dep",
                  ...
                  createBaseVNode("div", _hoisted_26, [
                    withDirectives(createBaseVNode("select", {
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(availableDependencies.value, (t) => {
